    ...
    showModal(modalDialog(
      ...
      tags$div(
        ...
        tags$div(
          ...
          "Rodríguez-Rodríguez, D., Solano-Moreno, F. J., Muñoz-Pérez, M. del R., Guzmán-Puyol, S., & Heredia-Guerrero, J. A. (2026). RSA-UVvis (v1.0.0). Zenodo."
        ),
        tags$p(style = "margin-top: 15px;", "DOI: 10.5281/zenodo.19206255"),
        tags$hr(),
