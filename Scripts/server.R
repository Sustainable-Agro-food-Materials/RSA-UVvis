    ...
    showModal(modalDialog(
      ...
      tags$div(
        ...
        tags$div(
          ...
          "Rodriguez-Rodriguez D, Solano-Moreno FJ, Muñoz-Perez MR, Guzman-Puyol S, Heredia-Guerrero JA. (2026). RSA-UVvis: A desktop software for antioxidant capacity analysis. Version 1.0.0."
        ),
        tags$p(style = "margin-top: 15px;", "DOI: [to be added]"),
        tags$hr(),
        tags$p(style = "font-style: italic;", "Software developed by the Sustainable Agri-Food Materials research group, at IHSM La Mayora.")
      )
    ))
  })
